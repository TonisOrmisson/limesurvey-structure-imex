...
class ComprehensiveAttributeExportTest extends DatabaseTestCase
{
    ...
    public function testQuestionTypeAttributeExport($questionType, $attributeName, $defaultValue, $changedValue)
    {
        ...
        if (QuestionAttributeLanguageManager::isGlobal($attributeName)) {
            // Global attribute should be in column 13 (global options) for 2-language survey  
            // Structure: type, subtype, code, value-en, help-en, script-en, value-et, help-et, script-et, relevance, mandatory, same_script, theme, options
            $globalOptions = isset($questionRow[13]) ? $questionRow[13] : '';
            ...
            // Language-specific attribute should be in columns 14 and 15 for 2-language survey
            $enOptions = isset($questionRow[14]) ? $questionRow[14] : '';
            $etOptions = isset($questionRow[15]) ? $questionRow[15] : '';
